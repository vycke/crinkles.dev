...
::: info
If you are curious about the actual changes, compare [Feo CSS](https://github.com/crinklesdev/feo-css) and the [/styles](https://github.com/crinklesdevs/crinkles.dev/tree/main/src/styles) directory of this website. The previous version of this website used Feo CSS before the migration.
:::
